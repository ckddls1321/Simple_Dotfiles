...
#kalibr_calibrate_cameras --models $CAMMODEL --topics $CAM0TOPIC $CAM1TOPIC --dont-show-report --bag $CALBAG --target $CALTARGET
...
kalibr_calibrate_imu_camera --target $CALTARGET --cam camchain-static.yaml --imu imu_cal.yaml --perform-synchronization --time-calibration --dont-show-report --bag $DYNAMICBAG --bag-from-to 10 70
...
cd ..
	...
	echo "\$3 : CAM0TOPIC : /cam0/image_raw, /dvs/image_raw"
fi
